...
execute if data block ~ ~ ~ Items[{Slot: 17b}].Count unless data block ~ ~ ~ Items[{Slot: 17b}].tag{ucit: {group: ["furniture_table/ui"]}} run data modify storage boomber:framework/furniture_table drop_items append from block ~ ~ ~ Items[{Slot: 17b}]
...
loot replace block ~ ~ ~ container.17 loot boomber:framework/trait/furniture_table/ui/blank
