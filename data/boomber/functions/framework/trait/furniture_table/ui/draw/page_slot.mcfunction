...
execute if score @s bb.fw.page matches 1.. run data modify block ~ ~ ~ Items[{Slot: 8b}].tag.display.Name set from block ~ 255 ~ Text1
execute if score @s bb.fw.page < #bb.fw.page_size bb.calculation run data modify block ~ ~ ~ Items[{Slot: 26b}].tag.display.Name set from block ~ 255 ~ Text2
