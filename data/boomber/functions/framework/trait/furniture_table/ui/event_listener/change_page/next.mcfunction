...
execute if score #bb.fw.page bb.calculation < #bb.fw.page_size bb.calculation run function boomber:framework/trait/furniture_table/ui/event/change_page/next
