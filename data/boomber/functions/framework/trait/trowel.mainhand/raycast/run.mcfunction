...
execute unless block ^ ^ ^0.1 #boomber:framework/trowel/placable if block ~ ~ ~ #boomber:framework/trowel/placable run function boomber:framework/trait/trowel.mainhand/raycast/end
