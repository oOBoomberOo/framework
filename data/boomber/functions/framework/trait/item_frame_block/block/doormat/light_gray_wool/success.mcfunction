...
execute as @e[type=armor_stand, tag=boomber.framework.template] run function boomber:framework/trait/item_frame_block/block/doormat/light_gray_wool/template_builder
kill @s